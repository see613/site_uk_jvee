    ...
    public function run(){
		...
		$config = array(
            ...
            'messages'=>array(
                 ...
                 'typeError'=>"The file {file} has a wrong extension. Allowed only: {extensions}.",
                 'sizeError'=>"Size of the file {file} is too big, maximum is {sizeLimit}.",
                 'minSizeError'=>"Size of the file {file} is too small, minimum is {minSizeLimit}.",
                 'emptyError'=>"{file} is empty, please select files again without it.",
                 'onLeave'=>"The files are being uploaded, if you leave now the upload will be cancelled."
            ),
